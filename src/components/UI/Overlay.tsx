...
export default function Overlay({ activeSection, setActiveSection, visitedCount, isEasterEggActive, setIsEasterEggActive }: OverlayProps) {
  ...
  return (
    <>
      {/* CSS for hover states — no JS state needed */}
      <style>{`
        .nav-btn {
          background: none;
          border: none;
        ...
        .resume-link:hover { color: #ffffff; }
        .hover-link {
          color: rgba(255,255,255,0.4);
          font-size: 0.85rem;
          letter-spacing: 0.1em;
      ...
      <div style={{
        ...
        <nav id="main-nav" style={{
          ...
          <div style={{ pointerEvents: 'auto', display: 'flex', justifyContent: 'center', flex: 1 }}>
            <button className="nav-logo" onClick={() => setActiveSection(null)}>
              JT
            </button>
          </div>
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <button
                    ...
                    style={{ background: 'none', border: 'none', color: '#aaaaaa', cursor: 'pointer', fontSize: '1.5rem' }}
                  >
                    &times;
                  </button>
                </div>
...
// NavButton — ScrambleText now writes to DOM directly (no re-renders), hover state is safe
