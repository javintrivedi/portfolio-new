    ...
    <>
      <div style={{
        ...
        <nav id="main-nav" style={{
          ...
          {/* Left */}
          <div style={{ display: 'flex', gap: '1.5rem', pointerEvents: 'auto', flex: 1 }}>
          ...
          <div style={{ pointerEvents: 'auto', display: 'flex', justifyContent: 'center', flex: 1 }}>
            <button className="nav-logo" onClick={() => setActiveSection(null)}>JT</button>
          </div>

          {/* Right */}
          <div style={{ display: 'flex', gap: '1.5rem', pointerEvents: 'auto', flex: 1, justifyContent: 'flex-end', position: 'relative' }}>
                ...
                {contactOpen && (
                  <motion.div
                    ...
                    style={{
                      ...
                      gap: '1rem', pointerEvents: 'auto'
                    }}
                  >
                    <a href="https://github.com/javintrivedi/"        target="_blank" rel="noopener noreferrer" className="hover-link">GITHUB</a>
                    <a href="https://www.linkedin.com/in/javintrivedi/" target="_blank" rel="noopener noreferrer" className="hover-link">LINKEDIN</a>
                    <a href="https://www.instagram.com/javintrivedi/" target="_blank" rel="noopener noreferrer" className="hover-link">INSTAGRAM</a>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
        ...
        {/* Weather Clock — hidden on mobile via .side-widget */}
        <AnimatePresence>
          {!activeSection && (
            <motion.div
        ...
        {/* Looping Scramble — hidden on mobile via .side-widget */}
        <AnimatePresence>
          {!activeSection && (
            <motion.div
              className="side-widget"
          ...
          <AnimatePresence mode="wait">
            {activeData?.id === 'projects' ? (
              <motion.div
                ...
                style={{
                  pointerEvents: 'auto', position: 'fixed', top: 0, left: 0,
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <h2 style={{ marginBottom: '0.5rem', fontSize: 'clamp(1.3rem, 4vw, 2rem)', color: activeData.color }}>{activeData.title}</h2>
                  <button onClick={() => setActiveSection(null)} style={{ background: 'none', border: 'none', color: '#aaaaaa', cursor: 'pointer', fontSize: '1.5rem' }}>
                    &times;
                  </button>
                </div>
                <h3 style={{ marginBottom: '1.5rem', fontSize: 'clamp(0.85rem, 2.5vw, 1.2rem)', color: '#aaaaaa', fontWeight: 'normal' }}>
                ...
                <ul style={{ listStyleType: 'none', padding: 0 }}>
                  {activeData.content.map((item, i) => (
                    <motion.li
                      ...
                      style={{ marginBottom: '0.8rem', lineHeight: 1.6, color: '#dddddd', fontSize: 'clamp(0.8rem, 2vw, 1rem)' }}
                    >
                      {item}
                    </motion.li>
                  ))}
          ...
          {!activeSection && (
            <motion.a
              ...
              style={{
                ...
                pointerEvents: 'auto', fontFamily: 'var(--font-space-mono)',
                fontSize: 'clamp(0.65rem, 1.5vw, 0.8rem)',
                letterSpacing: '0.2em', textDecoration: 'none', zIndex: 100,
          ...
          {!activeSection && (
            <motion.div
              ...
              style={{
                ...
                display: 'flex', gap: '1.2rem', pointerEvents: 'auto', zIndex: 100
              }}
            >
              <a href="https://www.instagram.com/javintrivedi/" target="_blank" rel="noopener noreferrer" className="social-link">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              </a>
              <a href="https://www.linkedin.com/in/javintrivedi/" target="_blank" rel="noopener noreferrer" className="social-link">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
              </a>
              <a href="https://github.com/javintrivedi/" target="_blank" rel="noopener noreferrer" className="social-link">
